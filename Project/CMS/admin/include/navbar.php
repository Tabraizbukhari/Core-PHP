    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Components">
          ...
          <li>
              <a href="post.php?source=addpost">Add new</a>
            </li>
            
            <li>
              <a href="post.php?source=category">Categories</a>
            </li>
          </ul>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Components">
          ...
          <ul class="sidenav-second-level collapse" id="collapsecomment">
            <li>
              <a href="comment.php">Comment List</a>
            </li>
         </ul>
        </li>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Example Pages">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseExamplePages" data-parent="#exampleAccordion">
            ...
            <span class="nav-link-text">Users Detail</span>
          </a>
          <ul class="sidenav-second-level collapse" id="collapseExamplePages">
            ...
            <li>
              <a href="user.php?source=adduser">Registration Page</a>
            </li>
            <!-- <li>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Menu Levels">
          ...
          <ul class="sidenav-second-level collapse" id="collapseMulti">
            <li>
              <a href="pages.php?source=addabout">About Add</a>
            </li>
            <li>
              <a href="pages.php">View all about</a>
            </li>
            <!-- <li>
      ...
      <li class="nav-item ">
        <a  class="nav-link text-center">
            <i class="fa fa-fw fa-users"></i> users online <span class="onlineuser"></span> </a>
        </li>
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle mr-lg-2 " id="alertsDropdown" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <i class="fa  "> <img src="<?php echo $userimage; ?>" width="30" height="30" class=" img-fluid rounded mx-auto d-block" >  
         </i>  </a>
          <div class="dropdown-menu" aria-labelledby="alertsDropdown">
